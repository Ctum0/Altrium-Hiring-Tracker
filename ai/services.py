...
SYSTEM_SCORE = (
    ...
    'Communication, Culture Fit. The three ratings MUST be differentiated: '
    'assess each criterion independently from the evidence in the notes, '
    'and do not return three identical or near-identical numbers. Words '
    'like "average" or "okay" about one criterion must pull that criterion '
    'down relative to the others. Respond ONLY with JSON like '
    '{"Technical Skill": 85, "Communication": 70, "Culture Fit": 55} '
